...
public:
  enum {
    ...
    T__7 = 8, T__8 = 9, NOT = 10, AND = 11, OR = 12, ASSIGN = 13, EQUAL = 14, 
    DIFF = 15, GT = 16, LT = 17, GTE = 18, LTE = 19, PLUS = 20, SUB = 21, 
    MUL = 22, DIV = 23, MOD = 24, VAR = 25, INT = 26, FLOAT = 27, BOOL = 28, 
    CHAR = 29, IF = 30, THEN = 31, ELSE = 32, ENDIF = 33, FUNC = 34, ENDFUNC = 35, 
    READ = 36, WRITE = 37, RETURN = 38, ID = 39, INTVAL = 40, STRING = 41, 
    COMMENT = 42, WS = 43, GTU = 44, LTU = 45
  };

  enum {
    RuleProgram = 0, RuleFunction = 1, RuleDeclarations = 2, RuleVariable_decl = 3, 
    RuleType = 4, RuleStatements = 5, RuleStatement = 6, RuleReturnFunction = 7, 
  ...
  class  ReturnFunctionContext : public antlr4::ParserRuleContext {
  public:
    ReturnFunctionContext(antlr4::ParserRuleContext *parent, size_t invokingState);
   
    ReturnFunctionContext() : antlr4::ParserRuleContext() { }
    void copyFrom(ReturnFunctionContext *context);
    using antlr4::ParserRuleContext::copyFrom;
  ...
  class  ReturnStmtContext : public ReturnFunctionContext {
  public:
    ReturnStmtContext(ReturnFunctionContext *ctx);
  ...
  ReturnFunctionContext* returnFunction();
  ...
  class  IndexArrayContext : public ExprContext {
  public:
    IndexArrayContext(ExprContext *ctx);
  ...
  public:
    ...
    antlr4::tree::TerminalNode *GTU();
    antlr4::tree::TerminalNode *GT();
    antlr4::tree::TerminalNode *LT();
    antlr4::tree::TerminalNode *LTU();
    virtual void enterRule(antlr4::tree::ParseTreeListener *listener) override;
    virtual void exitRule(antlr4::tree::ParseTreeListener *listener) override;
  };
